...
for i = 1: number_instance
    ...
    for solution_approach_index = 1:2
        ...
        eval(['load(''DATA/DC' num2str(instance_type) '/WorstCostSample/Cost_' solution_approach num2str(i) '.mat'');']);
    ...
    p_var10 = [cost_aro_prob(quantile_index_aro,1); cost_dist_prob(quantile_index_dist,1) ];
    ...
    p_var5 = [cost_aro_prob(quantile_index_aro,1); cost_dist_prob(quantile_index_dist,1)];
...
%eval(['save(''DATA/DC' num2str(instance_type) '/WorstCostAnalysis.mat'', ''P_*'');']);