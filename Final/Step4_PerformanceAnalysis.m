...
for i = 1:240
    ...
    p_var10 = [cost_aro_prob(quantile_index_aro,1); cost_ccg_prob(quantile_index_ccg,1); cost_bd_prob(quantile_index_bd,1); cost_eo_prob(quantile_index_eo,1); cost_um_prob(quantile_index_um,1)] - target;
    ...
    p_var5 = [cost_aro_prob(quantile_index_aro,1); cost_ccg_prob(quantile_index_ccg,1); cost_bd_prob(quantile_index_bd,1); cost_eo_prob(quantile_index_eo,1); cost_um_prob(quantile_index_um,1)] -target ;
...
eval(['save(''DATA/DC' num2str(instance_type) '/CostAnalysis.mat'', ''P_*'');']);