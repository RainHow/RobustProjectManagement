...
for instance_index = 1
    ...
    for solution_approach_index = 2
        ...
        dist_information = load(['DATA/DC' num2str(instance_type) '/WorstCase/worst_aro' num2str(instance_index) '.mat']);
        eval(['State = dist_information.DELTA_aro_prob'';'])
        eval(['probability = dist_information.prob_aro;'])
        ...
        save(['DATA/DC' num2str(instance_type) '/WorstCostSample/Cost_' solution_approach num2str(instance_index) '.mat'], 'cost_sample', 'probability');
    end
end
