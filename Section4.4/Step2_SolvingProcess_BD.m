...
for i = 1:240
    ...
    [obj_bd, x_bd, y_bd, DELTA_bd, LAMBDA_bd, UB, LB, Iteration_bd] = BD(tolerant, A_xy,b_xy,N,N_pr,M,K,Q,bar_n, Ux,Uy,Gf,Gc,d,AF,ACC,AV,AC,AX,AY,AZ,B0,Z,Z0,L, REALIZATION);
    T_bd = toc(whole_solution_t_start);
    
    save(outputfile, 'obj_bd', 'x_bd', 'y_bd', 'DELTA_bd', 'LAMBDA_bd', 'T_bd', 'Iteration_bd');
