...
for instance_index = 1:120
    ...
    State = dist_information.DELTA_aro_prob';
    probability = dist_information.prob_aro;
    ...
    for solution_approach_index = 1:2
        ...
        save(['DATA/DC' num2str(instance_type) '/WorstSample_ARO/Cost_' solution_approach num2str(instance_index) '.mat'], 'cost_sample', 'probability');
    end
end
