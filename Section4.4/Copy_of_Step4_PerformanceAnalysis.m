...
for i = 1:240
    ...
    p_el = [ quantile_aro(:,1)'*quantile_aro(:,2); sum(quantile_ccg(:,1).*quantile_ccg(:,2)); sum(quantile_bd(:,1).*quantile_bd(:,2)); sum(quantile_eo(:,1).*quantile_eo(:,2));sum(quantile_um(:,1).*quantile_um(:,2))];
