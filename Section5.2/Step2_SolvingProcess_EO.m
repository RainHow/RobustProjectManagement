...
for i = 1689
    ...
    [ obj_eo, x_eo, y_eo, DELTA_eo, Iteration_eo, RHS_eo, obj_bilinear_eo ] = EO( A_xy, b_xy, N, N_pr, M, K, Q, bar_n, Ux, Uy, Gf, Gc, d, AF, ACC, AV, AC, AX, AY, AZ, B0, Z, Z0, Mu, Sigma, Cor, L, REALIZATION );
    T_eo = toc(whole_solution_t_start);
    

    save(outputfile, 'obj_eo', 'x_eo', 'y_eo', 'DELTA_eo', 'Iteration_eo', 'T_eo', 'RHS_eo', 'obj_bilinear_eo' );    
